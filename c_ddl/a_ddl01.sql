...
### DDL(Date definition Language) 문법 정리 ###
...
-- CREATE DATABASE example3 -- 다음 문장이 있는경우 필수
...
# cf) ci (case-insenstive): 대소문자 구분하지 않음 ('abc' = 'ABC')
# cf) utf8mb4_general_ci: 속도가 빠름, 정확도 낮음

# utf8(문자끼리만 인코딩) VS utf8mb4(모든 유니코드 문자저장 - 이모지 & 한자 포함)
# No database selected Select the default DB to be used by double-clicking its name 
