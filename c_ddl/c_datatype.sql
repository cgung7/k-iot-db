...
/*
    ...
    */
    ...
    value (`laptop Sansung Book 3 Pro`, `전자제품`, `삼성 갤럭시 북3 노트북 프로입니다. 아주 좋아요`,`example`);
    ...
    */
    ...
    create table product (
        ...
        price1 float(7, 2),	-- float, double의 형태로만 사용
        -- price float (권장)
        price2 double(10, 4),
        -- price double (권장)
        price decimal(15,2) -- decomal은 실제 자리수 사용을권장
    );
    
    insert into product
    value (12345.67, 123456.7890, 999999999.99);
