...
/*
    ...
    2. 정규화 목적
		1) 중복 정규화: 데이터의 재 사용성과 저장 공간 효울 증가
	...
	4. 정규화 필요성
        ...
        >> 위 테이블의 문제점
            ...
            2) 이상 현상 발생
				...
				- 수정 이상: 같은 강사명이나 학생명을 여러 행의 걸쳐 모두 수정
        ...
        5. 정규화의 단계
            ...
            2) 제 2 정규형
				: 1NF 만족 + 기본키(PK)에 대한 완전 함수 종속
                - 부분 종속 제거 (복합키(FK)의 일부 컬럼에만 의존하는 속성 분리)
...
CREATE TABLE IF NOT EXISTS `student_course` (
    ...
    primary key (student_id, course_id) ## student_id + course_id는 중복 허용 X / 비워질 수 없음 (기본키 설정)
);

INSERT INTO `student_course`
VALUES
	(1, '이상은', 101, '생성형 AI', '김준일'),
	(1, '이상은', 102, '챗 GPT', '이승아'),
	(2, '박진영', 102, '챗 GPT', '이승아'),
	(3, '오신혁', 103, '빅데이터', '안근수');
...
### 이상 현상 예시 ###
# 1) 삽입 이상
-- INSERT INTO `student_course` (course_id, course_name, course_instuctor)
-- VALUES
-- 	(104, '코리아IT', '조승범');
# Error Code: 1364
...
### 정규화 사용 모범 사례 ###
# 정규화가 무조건적인 정답은 아니다
# : 과도한 정규화는 JOIN 이 많아져서 성능 저하의 우려 발생
