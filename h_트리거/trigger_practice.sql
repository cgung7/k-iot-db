...
CREATE TABLE IF NOT EXISTS players_delete_logs (
	log_id INT AUTO_INCREMENT PRIMARY KEY,
    player_name VARCHAR(50),
    delete_time datetime
);
SELECT * FROM players_delete_logs;

insert into players
values
	(1, 'JTC', '타자', '2025-07-31', 1),
	(2, 'LMV', '투수', '2025-07-31', 2),
	(3, 'DSA', '외야수', '2025-07-31', 3),
	(4, 'LSA', '타자', '2025-07-31', 1);
    
SELECT * FROM players;

drop trigger if exists players_updateTrg;
