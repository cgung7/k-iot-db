...
/*
    ...
    cf) 뷰 이름은 테이블과 구분을 위해 'v_'로 시작을 권장
*/
...
# cf) 뷰(View) VS 반정규화
# 뷰: 실제 데이터를 복제하지 않고 조인 결과를 미리 정의 ('마치 테이블 처럼') /하나의 JOIN

# 반정규화: 정규화된 테이블을 의도적으로 중복하거나 
#		 조인 없이 조회할 수 있도록 재구성 - 성능 최적화 / 하나 이상의 JOIN
