...
# > 위 두 개의 실행문은 여러 번 실행할 경우 Error 발생
...
# --- 테이블 수정 ---
# alter table
# : 이미 존재하는 테이블의 구조는 변경하는 데 사용
# - 컬럼 또는 제약 조건을 추가, 수정, 삭제

# 1) 컬럼
# : 컬럼 추가 (add)
# alter table 테이블명 add column 컬럼명 데이터 타입 기타사항;
...
# : 컬럼 수정 (modify)
# alter table 테이블명 modify column 컬럼명 새로운 컬럼_테이터타입 [기타사항];
alter table student
